...
export default function VistaLlamadosSecretaria() {
          ...
          <div className="space-y-4">
            {llamadosDashboard.pendientes.map(p => (
              <SortableItem
                ...
                onConfirmarAccion={(id, accion, nombre) => confirmarCambioEstado(id, accion, nombre)}
              />
            ))}
          </div>
        </SortableContext>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <div {...listeners} className="cursor-grab px-2">☰</div>
        <div>
      ...
      <div className="space-x-2">
        <button
          onClick={(e) => {
            ...
            onConfirmarAccion(id, "Llamado", nombre);
          }}
        ...
        <button
          onClick={(e) => {
            ...
            onConfirmarAccion(id, "Atendido", nombre);
          }}
        ...
        <button
          onClick={(e) => {
            ...
            onConfirmarAccion(id, "Cancelado", nombre);
          }}
